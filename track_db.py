    ...
    for i in runners:
        for j in range(len(runners_time)):
            if i.last_race_time == runners_time[j]:
                #print(i)
                backend.update_athlete(i.id, place=(j+1))
...
runners = []
runners2 = [
     backend.get_athlete(14),
     backend.get_athlete(19),
     backend.get_athlete(26),
     backend.get_athlete(39),
     backend.get_athlete(48),
     backend.get_athlete(54),
     backend.get_athlete(65),
     backend.get_athlete(66)
]
